...
export function Relatorios() {
  const [maisMovimentados, setMaisMovimentados] = useState<
    LinhaMovimentacao[] | null
  >(null);
  ...
  useEffect(() => {
    api<LinhaMovimentacao[]>("/relatorios/movimentacao-por-produto").then(
      setMaisMovimentados,
    );
    api<{ linhas: LinhaValor[]; valorTotal: number }>(
      "/relatorios/valor-total-estoque",
    ...
    <div className="space-y-4 pt-2">
      ...
      <div className="cartao">
        ...
        <div className="text-2xl font-semibold mb-2">
          {valorEstoque?.valorTotal.toLocaleString("pt-BR", {
            style: "currency",
            currency: "BRL",
          })}
        </div>
          ...
          {valorEstoque?.linhas.map((linha) => (
            ...
            >
              ...
              <span className="text-gray-500">
                {linha.valorEstoque.toLocaleString("pt-BR", {
                  style: "currency",
                  currency: "BRL",
                })}
              </span>
